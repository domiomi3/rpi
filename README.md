...
one
python src/test.py --protein_embeddings_path data/embeddings/one_hot_protein.npy --rna_embeddings_path data/embeddings/one_hot_rna.npy --test_set_path /work/dlclarge1/matusd-rpi/RPI/data/interactions/test_set.parquet --checkpoint_path "checkpoints/last-r_one_hot, lr: 0.001, wd: 0.1, dr: 0.3, seed: 17.ckpt"
