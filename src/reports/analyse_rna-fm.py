...
random_test_split_files = [
    "rna-fm/rna-fm-random-test-split-0.json",
    "rna-fm/rna-fm-random-test-split-1.json",
    "rna-fm/rna-fm-random-test-split-2.json",
]

test_split_files = [
    "rna-fm/rna-fm-test-split-0.json",
    "rna-fm/rna-fm-test-split-1.json",
    "rna-fm/rna-fm-test-split-2.json",
]

rpi_split_files = [
    "rna-fm/rna-fm-rpi2825-0.json",
    "rna-fm/rna-fm-rpi2825-1.json",
    "rna-fm/rna-fm-rpi2825-2.json",
]
